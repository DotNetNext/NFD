$(document).ready(function(){
	...
	{
	    $('#bs-css').attr('href', '/Content/Templates/usmanhalalit-charisma-d29440e/css/bootstrap-' + theme_name + '.css');
	}
...
$.alert = function (message, title) {
    $('#divAlert').find(".modal-body").html(message);
    $('#divAlert').find(".modal-title").html( title);
    $('#divAlert').modal({
        keyboard: true
    })
}
$.confirm = function (message, title, fu) {
    $('#divConfirm').find(".modal-body").html(message);
    $('#divConfirm').find(".modal-title").html(title);
    $('#divConfirm').modal({
        keyboard: true
    })
    var go = $('#divConfirm').find("#btnGo");
    go.unbind();
    go.click(function () {
        fu();
    })
