namespace System.Linq.Dynamic
{
    ...
    internal class ExpressionParser
    {
        ...
        {
            Func<MethodData, bool> func = null;
            ...
            if (applicable.Length > 1)
            {
                if (func == null)
                {
                    func = m => Enumerable.All<MethodData>(applicable, delegate (MethodData n) {
                        if (m != n)
                        {
                ...
                applicable = Enumerable.Where<MethodData>(applicable, func).ToArray<MethodData>();
            }
            if (applicable.Length == 1)
            {
