namespace Trirand.Web.Mvc
{
    ...
    public class JQMultiSelect
    {
        public JQMultiSelect()
        {
            ...
            this.Filter = Trirand.Web.Mvc.Filter.None;
        }

        public static List<JQListItem> GetSelectedItems(string json)
        {
            return new JavaScriptSerializer().Deserialize<List<JQListItem>>(json);
        }
        ...
        public Trirand.Web.Mvc.Filter Filter { get; set; }
