namespace Trirand.Web.Mvc
{
    ...
    public class ChartBaseAxisSettings
    {
        public ChartBaseAxisSettings()
        {
            ...
            this.TickmarkPlacement = Trirand.Web.Mvc.TickmarkPlacement.Between;
            this.TickWidth = 1;
        ...
        public ChartLineDashStyle GridLineDashStyle { get; set; }

        public int GridLineWidth { get; set; }

        public string ID { get; set; }

        public ChartLabelSettings Labels { get; set; }
        ...
        public Trirand.Web.Mvc.TickmarkPlacement TickmarkPlacement { get; set; }
